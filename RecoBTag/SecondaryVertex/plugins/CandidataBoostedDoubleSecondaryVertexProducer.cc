...
#include "DataFormats/BTauReco/interface/CandBoostDoubleSecondaryVertexTagInfo.h"
...
class CandidataBoostedDoubleSecondaryVertexProducer : public edm::stream::EDProducer <> {
public:
   explicit CandidataBoostedDoubleSecondaryVertexProducer(const edm::ParameterSet&);
...
CandidateBoostedDoubleSecondaryVertexProducer::CandidateBoostedDoubleSecondaryVertexProducer(const edm::ParameterSet & parameters) :
...
void CandidateBoostedDoubleSecondaryVertexProducer::initialize(const JetTagComputerRecord & record)
{
...
float CandidateBoostedDoubleSecondaryVertexProducer::discriminator(const TagInfoHelper & tagInfo) const
{
	// get TagInfos
...
void CandidateBoostedDoubleSecondaryVertexProducer::calcNsubjettiness(const reco::JetBaseRef & jet, float & tau1, float & tau2, std::vector<fastjet::PseudoJet> & currentAxes) const
{
...
void CandidateBoostedDoubleSecondaryVertexProducer::setTracksPVBase(const reco::TrackRef & trackRef, const reco::VertexRef & vertexRef, float & PVweight) const
{
	PVweight = 0.;
...
void CandidateBoostedDoubleSecondaryVertexProducer::setTracksPV(const reco::CandidatePtr & trackRef, const reco::VertexRef & vertexRef, float & PVweight) const
{
	PVweight = 0.;
...
void CandidateBoostedDoubleSecondaryVertexProducer::etaRelToTauAxis(const reco::VertexCompositePtrCandidate & vertex,
